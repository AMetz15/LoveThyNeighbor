...
function initMap() {
 ...
 debugger;
    ...
    autocomplete.addListener('place_changed', function() {
        ...
        switch(pantry) {
            case 1:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>The Lakeview Food Pantry</strong><hr>Lakeview Baptist Church<br>7 S. 20th St, Battle Creek, MI 49015<br><br>M: 9:30a - 11:45a<br>W: 9:30a - 11:45a<br>F: 9:30a - 11:45a<hr><button onclick="setInfantContent(1)">Click here for information on infant supplies.</button><br><div id="infantInfo1"></div></div>');
                break;
            case 2:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>Love Thy Neighbor Ministries</strong><hr>Love Thy Neighbor Community Center<br>1391 E. Michigan Ave., Battle Creek MI49014<br><br>M: 3:00p - 6:00p<br>W: 9:00a - 12:00p<br>F: 9:00a - 12:00p<br><a href="http://BCLoveThyNeighbor.org">Website</a><hr><button onclick="setInfantContent(2)">Click here for information on infant supplies.</button><br><div id="infantInfo2"></div></div>');
                break;
            case 3:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>The North East Food Pantry</strong><hr>Maple United Methodist Church<br>342 Capital Ave NE, Battle Creek, MI 49017<br><br>M: 9:00a - 11:45a<br>T: 9:00a - 11:45a<br>W: 9:00a - 11:45a<br>R: 9:00a - 11:45a<br>F: 9:00a - 11:45a<hr><button onclick="setInfantContent(3)">Click here for information on infant supplies.</button><br><div id="infantInfo3"></div></div>');
                break;
            case 4:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>The Urbandale Food Pantry</strong><hr>Overflow Church<br>3515 W Michigan Ave, Battle Creek, MI 49037<br><br>M: 10:00a - 12:00p<br>T: 10:00a - 12:00p<br>R: 10:00a - 12:00p<hr><button onclick="setInfantContent(3)">Click here for information on infant supplies.</button><br><div id="infantInfo3"></div></div>');
                break;
            case 5:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>Parkway Manor Food Pantry</strong><hr>Parkway Manor Community Building<br>380 Truth Dr., Battle Creek, MI 49017<br><br>M: 9:45a - 11:45a<br>W: 9:45a - 11:45a<br>F: 9:45a - 11:45a<hr><button onclick="setInfantContent(4)">Click here for information on infant supplies.</button><br><div id="infantInfo4"></div></div>');
                break;
            case 6:
                infowindow.setContent('<div style="Text-align:center;color:black">Your food pantry is:<br><br><strong>The Franklin Food Pantry</strong><hr>First United Methodist Church<br>111 E. Michigan Ave., Battle Creek, Mi 49017<br><br>M: 1:00p - 3:00p<br>T: 1:00p - 3:00p<br>H: 1:00p - 3:00p<hr><button onclick="setInfantContent(5)">Click here for information on infant supplies.</button><br><div id="infantInfo5"></div></div>');
                break;
            default:
